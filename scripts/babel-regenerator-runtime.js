// https://github.com/Tencent/wepy/blob/2.0.x/packages/babel-plugin-import-regenerator/index.js
        ...
        if (callee.node && callee.node.object && callee.node.property) {
          if (t.isIdentifier(callee.node.object, { name: 'regeneratorRuntime' })) {
            ...
            if (wm.has(programPath.node)) {
              ...
              runtimeId = helperModelImports.addDefault(programPath, './lib/regenerator-runtime', {
